...
public class MainActivity extends Activity {
    ...
    private String signalDeckSkinScriptV2() {
        return "(function(){"
                ...
                + "hideForeignPanels();hideReceiverSections();hideNativeImageExpander();hideNativeStatusMeters();"
                + "new MutationObserver(function(){hideForeignPanels();hideReceiverSections();hideNativeImageExpander();hideNativeStatusMeters();}).observe(document.body,{childList:true,subtree:true});"
                + "})();";
    }
