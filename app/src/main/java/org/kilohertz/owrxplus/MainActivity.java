...
public class MainActivity extends Activity {
    ...
    private String signalDeckSkinScriptV2() {
        return "(function(){"
                ...
                + ".signaldeck-skin .sd-decoder-grid{display:grid!important;width:calc(100% - 8px)!important;margin:0 auto!important;gap:0!important;background:transparent!important;border:0!important;border-radius:5px!important;overflow:hidden!important;}"
                ...
                + ".signaldeck-skin [data-signaldeck-decoder-output=true] table:not([data-signaldeck-decoder-table=true]){width:100%!important;max-width:100%!important;table-layout:fixed!important;border-collapse:collapse!important;border:0!important;font:11px/14px sans-serif!important;}"
                + ".signaldeck-skin [data-signaldeck-decoder-output=true] th,.signaldeck-skin [data-signaldeck-decoder-output=true] td{padding:4px 5px!important;border:0!important;box-shadow:none!important;outline:0!important;background:transparent!important;white-space:normal!important;overflow-wrap:anywhere!important;word-break:break-word!important;}"
