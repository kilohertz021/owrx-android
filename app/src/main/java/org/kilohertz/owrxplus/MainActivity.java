...
public class MainActivity extends Activity {
    ...
    private String signalDeckSkinScriptV2() {
        return "(function(){"
                ...
                + ".signaldeck-skin #signaldeck-waterfall-controls{position:fixed!important;display:none;z-index:91!important;padding:7px 8px!important;border:1px solid rgba(159,234,255,.24)!important;background:rgba(5,13,21,.94)!important;border-radius:4px!important;box-shadow:0 12px 28px rgba(0,0,0,.35)!important;box-sizing:border-box!important;}"
                ...
                + "@media (orientation:landscape){.signaldeck-skin #signaldeck-receiver-handle{top:78px!important;}.signaldeck-skin #openwebrx-panel-receiver{top:104px!important;height:52vh!important;max-height:52vh!important;}}"
                + "';"
                ...
                + "function nativeWaterfallInput(which){return document.getElementById(which==='min'?'openwebrx-waterfall-color-min':'openwebrx-waterfall-color-max');}"
                ...
                + "hideForeignPanels();hideReceiverSections();tidyDigRow();ensureWaterfallControls();hideNativeImageExpander();hideNativeStatusMeters();setInterval(ensureWaterfallControls,900);"
                + "new MutationObserver(function(){hideForeignPanels();hideReceiverSections();tidyDigRow();hideNativeImageExpander();hideNativeStatusMeters();}).observe(document.body,{childList:true,subtree:true});"
                + "})();";
    }
