...
public class MainActivity extends Activity {
    ...
    private String signalDeckSkinScriptV2() {
        return "(function(){"
                ...
                + ".signaldeck-skin #signaldeck-waterfall-controls{display:block!important;margin:8px 0 0!important;padding:8px 9px!important;border:1px solid rgba(159,234,255,.24)!important;background:rgba(5,13,21,.64)!important;border-radius:4px!important;}"
                + ".signaldeck-skin #signaldeck-waterfall-controls .sd-wf-head{display:flex!important;align-items:center!important;justify-content:space-between!important;margin-bottom:6px!important;color:#edf8ff!important;font:700 12px/14px sans-serif!important;letter-spacing:.2px!important;}"
                + ".signaldeck-skin #signaldeck-waterfall-controls .sd-wf-actions{display:flex!important;gap:6px!important;}"
                + ".signaldeck-skin #signaldeck-waterfall-controls button{height:24px!important;min-height:24px!important;padding:0 9px!important;border-radius:4px!important;border:1px solid rgba(159,234,255,.38)!important;background:rgba(16,40,58,.92)!important;color:#fff!important;font:700 10px/22px sans-serif!important;}"
                + ".signaldeck-skin #signaldeck-waterfall-controls .sd-wf-row{display:grid!important;grid-template-columns:42px 1fr 42px!important;align-items:center!important;gap:8px!important;margin-top:5px!important;color:#b8ccd8!important;font:700 11px/18px sans-serif!important;}"
                + ".signaldeck-skin #signaldeck-waterfall-controls input[type=range]{width:100%!important;height:28px!important;margin:0!important;padding:0!important;background:transparent!important;border:0!important;accent-color:#9feaff!important;}"
                + ".signaldeck-skin #signaldeck-waterfall-controls .sd-wf-value{text-align:right!important;color:#edf8ff!important;font:700 10px/18px monospace!important;}"
                ...
                + "@media (orientation:landscape){.signaldeck-skin #signaldeck-receiver-handle{top:78px!important;}.signaldeck-skin #openwebrx-panel-receiver{top:104px!important;height:58vh!important;max-height:58vh!important;}}"
                + "';"
                ...
                + "hideForeignPanels();hideReceiverSections();ensureWaterfallControls();hideNativeImageExpander();hideNativeStatusMeters();"
                + "new MutationObserver(function(){hideForeignPanels();hideReceiverSections();ensureWaterfallControls();hideNativeImageExpander();hideNativeStatusMeters();}).observe(document.body,{childList:true,subtree:true});"
                + "})();";
    }
