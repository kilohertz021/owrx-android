...
public class MainActivity extends Activity {
    ...
    private String signalDeckSkinScriptV2() {
        return "(function(){"
                ...
                + "@media (orientation:landscape){.signaldeck-skin #signaldeck-receiver-handle{top:78px!important;}.signaldeck-skin #openwebrx-panel-receiver{top:78px!important;width:min(62vw,520px)!important;height:64vh!important;max-height:64vh!important;}}"
                + "';"
