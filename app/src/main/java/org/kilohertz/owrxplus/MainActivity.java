...
public class MainActivity extends Activity {
    ...
    private String signalDeckSkinScriptV2() {
        return "(function(){"
                ...
                + "hideForeignPanels();hideReceiverSections();tidyDigRow();ensureWaterfallControls();hideNativeImageExpander();hideNativeStatusMeters();installReceiverSwipe();setInterval(ensureWaterfallControls,900);"
                + "new MutationObserver(function(){hideForeignPanels();hideReceiverSections();tidyDigRow();hideNativeImageExpander();hideNativeStatusMeters();installReceiverSwipe();}).observe(document.body,{childList:true,subtree:true});"
                + "})();";
    }
