...
public class MainActivity extends Activity {
    ...
    private String signalDeckSkinScriptV2() {
        return "(function(){"
                ...
                + ".signaldeck-skin .sd-decoder-grid{display:grid!important;width:calc(100% - 8px)!important;margin:0 auto!important;gap:0!important;background:rgba(0,62,72,.92)!important;border:0!important;border-radius:0!important;overflow:visible!important;}"
                + ".signaldeck-skin .sd-decoder-row{display:grid!important;grid-template-columns:var(--sd-grid,repeat(var(--sd-cols),minmax(0,1fr)))!important;gap:0!important;min-width:0!important;background:rgba(0,62,72,.92)!important;border:0!important;}"
                + ".signaldeck-skin .sd-decoder-cell{min-width:0!important;padding:4px 6px!important;background:rgba(0,62,72,.92)!important;border:0!important;box-shadow:none!important;outline:0!important;color:#edf8ff!important;font:11px/14px sans-serif!important;white-space:normal!important;overflow-wrap:anywhere!important;word-break:break-word!important;}"
                + ".signaldeck-skin .sd-decoder-row:first-child{background:rgba(255,255,255,.92)!important;}.signaldeck-skin .sd-decoder-row:first-child .sd-decoder-cell{font-weight:800!important;text-align:center!important;background:rgba(255,255,255,.92)!important;color:#16232c!important;}"
